...
<body>
			...
			<input type ="text" name ="username" placeholder = "Nurse username "required > 
			...
			if(isset($_POST['submit'])){
				...
				if ($username && $password && $cpassword && $email ) {
						if ($password == $cpassword) {
							...
							$sql = "INSERT into nurse (username,password,email)
									VALUES
							...
							# code...
								if ($result) {
									echo "<font color='blue'>New Nurse Record Added</font>";
